export default function MysoreDeliveryCart({ value }) {
    let abc=value?.info?.cta?.link;
    console.log(abc)
    return (

        <div className="min-w-[150px] h-[340px] rounded-xl  bg-white  overflow-hidden my-10">
            ...
            <div className="p-3 space-y-1">
                ...
                <p className="font-semibold text-sm text-gray-800">
                    <span className=" bg-green-500 rounded-2xl  text-center">⭐</span> {value?.info?.avgRating} <strong>•</strong>{" "}
                ...
                <h1 className="text-sm text-gray-500 font-lg">
                    {value?.info?.areaName}
                </h1>
